...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("vsSrc.vs", "fsSrc.fs");
    ...
    // --------------------
    lightingShader.use();
    lightingShader.setInt("materialtex.diffuse", 0);
    lightingShader.setInt("materialtex.specular", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("materialtex.shininess", 32.0f);
